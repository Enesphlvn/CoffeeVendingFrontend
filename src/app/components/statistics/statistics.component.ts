...
export class StatisticsComponent implements OnInit {
  ...
  topAndLeastSoldChartFilled() {
    this.statisticsService.getAllStatistics().subscribe((response) => {
      ...
      this.topAndLeastSoldproductChartLabel.push('Ürün Satış Adet Tablosu');

      this.topSoldProductChartData = [
  ...
  topAndLeastUserSoldChartFilled() {
    this.statisticsService.getAllStatistics().subscribe((response) => {
      ...
      this.topAndLeastUserSoldChartLabel.push('Kullanıcı Sipariş Adet Tablosu');
